...
export default function ChatContainer({ currentChat, socket ,handleRecent}) {
...
useEffect(()=>{
  ...
  const handleSendMsg = async (msg) => {
    ...
    setMessages(msgs)
    handleRecent(currentChat?._id,msg,data?._id)
  ...
  useEffect(() => {
    if (socket.current) {
      socket.current.on("msg-recieve", (msg) => {
        console.log('jooooo',msg)
        handleRecent(msg.from,msg.message,msg.to)
